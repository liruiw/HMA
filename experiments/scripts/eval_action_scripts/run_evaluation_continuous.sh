...
accelerate launch --main_process_port $MASTER_PORT hma/evaluate_diffusion.py --checkpoint_dir data/${script_name} --use_raw_image \
...
python hma/generate.py   --checkpoint_dir data/${script_name}  \
    ...
    --output_dir data/${DATASET}/output --use_feature

# visualize
python hma/visualize.py --token_dir data/${DATASET}/output --use_feature
